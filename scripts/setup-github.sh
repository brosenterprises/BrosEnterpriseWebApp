...
echo ""
echo "   git remote set-url origin https://github.com/shushi3101/BrosEnterpriseWebApp.git"
echo "   git push -u origin main"
echo ""
echo "3. When prompted for credentials:"
echo "   - Username: shushi3101"
...
echo "   https://github.com/shushi3101/BrosEnterpriseWebApp"
echo ""
